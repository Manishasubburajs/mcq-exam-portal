    ...
    <Box sx={{ display: 'flex', minHeight: '100vh', backgroundColor: 'grey.50' }}>
      ...
      <Box className={`main-content ${sidebarOpen ? 'sidebar-open' : 'sidebar-closed'}`} sx={{
        ...
        <CreateExamModal
          ...
          setExamTypeSelection={setExamTypeSelection}
          practiceExamForm={practiceExamForm}
          setPracticeExamForm={setPracticeExamForm}
          mockExamForm={mockExamForm}
          setMockExamForm={setMockExamForm}
          liveExamForm={liveExamForm}
          setLiveExamForm={setLiveExamForm}
          subjects={subjects}
          topics={topics}
          questionCounts={questionCounts}
          onSubmitPractice={handleSubmitPracticeExam}
          onSubmitMock={handleSubmitMockExam}
          onSubmitLive={handleSubmitLiveExam}
          fetchTopicsForSubject={fetchTopicsForSubject}
        />
